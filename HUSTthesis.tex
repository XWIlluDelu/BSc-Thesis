	...
	\def\HUSTtitlelength{12em}
 	\begin{titlepage}
		\begin{center}
			...
			\includegraphics[height=1.61cm]{HUSTGreen.eps}\\
%
			\vspace*{4em}
%
...
\setcounter{page}{1}
\renewcommand{\thepage}{\Roman{page}}
\input{doc/abstract_cn.tex}

% ----------------------------------- 英文摘要 ----------------------------------- %
\input{doc/abstract_en.tex}
...
% ---------------------------------------------------------------------------- %
\include{doc/chapter_1}
% ---------------------------------------------------------------------------- %
\include{doc/chapter_2}
% ---------------------------------------------------------------------------- %
\include{doc/chapter_3}

% ------------------------------------ 致谢 ------------------------------------ %
\input{doc/acknowledgment.tex}
